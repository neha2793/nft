...
export default function Home() {
  ...
  async function buyNft(nft) {
    ...
    await axios.get(process.env.NEXT_PUBLIC_BASE_URL+'/api/check-auth').then((response)  => {
                      ...
                      <div className="nftbox">
                        ...
                        <div className="nftbox-desc">
                          <div className="nftbox-desc-img">
                            ...
                            <span><a  onClick={() => wishlist(nft.wishlist_id, nft.id)} id={nft.wishlist_id}  ><i className={nft.wishlist == 1 ? 'fa fa-heart-o active':'fa fa-heart-o'} aria-hidden="true"></i>{nft.wishlist == 1 ? 1 : 0}</a></span>
                          </div>
